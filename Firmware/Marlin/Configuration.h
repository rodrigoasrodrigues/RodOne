...
#define STRING_CONFIG_H_AUTHOR "Rodrigo Rodrigues" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.1510,79.3917,1603.5839,666.6}  
/**
...
#define DEFAULT_MAX_FEEDRATE        {FEEDX/60, FEEDY/60, FEEDZ/60, FEEDE/60} 
...
#define DEFAULT_ACCELERATION          ACCX   // X, Y, Z and E max acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  ACCE     // X, Y, Z and E max acceleration in mm/s^2 for retracts
...
#define XY_PROBE_SPEED min(FEEDX,FEEDY)/2
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY min(FEEDX,FEEDY)/2
#define HOMING_FEEDRATE_Z  FEEDZ
