...
#define CUSTOM_MACHINE_NAME "RodOne"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.6019, 79.6019, 406.6750, 637.7551 }
...
#define XY_PROBE_SPEED min(FEEDX,FEEDY)*30
...
#define HOMING_FEEDRATE_XY min(FEEDX,FEEDY)*30
#define HOMING_FEEDRATE_Z  FEEDZ*30
